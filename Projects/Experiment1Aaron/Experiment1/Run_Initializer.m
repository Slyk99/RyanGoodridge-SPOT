...
% appHandle.AvailableDiagramsDropDown.Value = "Experiment1.slx";
% 
% % Ensure the diagram is loaded
% open(appHandle.AvailableDiagramsDropDown.Value);


appHandle.DurPhase0EditField.Value=0;
appHandle.DurPhase1EditField.Value=0;
appHandle.DurPhase2EditField.Value=0;
appHandle.SubPhase1EditField.Value=10;
...
appHandle.SampleRateEditField.Value=1000;



appHandle.SubAppInitialConditions.REDInitialX.Value  = 2.66;  % [m]
appHandle.SubAppInitialConditions.REDInitialY.Value  = 1.21;  % [m]
appHandle.SubAppInitialConditions.REDInitialTh.Value = 90;   % [deg]
appHandle.SubAppInitialConditions.BLACKInitialX.Value  = 1.55;  % [m]
appHandle.SubAppInitialConditions.BLACKInitialY.Value  = 1.21;  % [m]
appHandle.SubAppInitialConditions.BLACKInitialTh.Value = 270;   % [deg]

appHandle.SubAppInitialConditions.REDHomeX.Value=2.66;
appHandle.SubAppInitialConditions.REDHomeY.Value=1.21;
appHandle.SubAppInitialConditions.REDHomeTh.Value=90;
appHandle.SubAppInitialConditions.BLACKHomeX.Value  = 1.55;  % [m]
appHandle.SubAppInitialConditions.BLACKHomeY.Value  = 1.21;  % [m]
appHandle.SubAppInitialConditions.BLACKHomeTh.Value = 270;   % [deg]


% appHandle.RED_Drop=[2.66;1.21;90];
% appHandle.RED_Initial=[2.66;1.21;90];
% appHandle.RED_Home=[2.66;1.21;90];
% 
% appHandle.REDCheckBox.Value    = 1;
% appHandle.BLACKCheckBox.Value  = 1;
% appHandle.BLUECheckBox.Value   = 0;
% appHandle.ARMCheckBox.Value    = 1;

appHandle.SubAppInitialConditions.UpdateInitialConditions();
appHandle.UpdateTimes();
appHandle.UpdateSimulationParameters();
