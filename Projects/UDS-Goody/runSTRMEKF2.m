function [x, Rot, P, y, H, V] = runSTRMEKF2(Chaser, z, Rot_obs, dt, x, Rot, P, Q, R, V, r, rho, dmax)
...
%   d        - Mahalanobis distance
    ...
    % Run the MEKF
    [x, Rot, P, y, H, V] = STRMEKF2(z, Rot_obs, dt, x, Rot, P, Q, R, V, r, rho, dmax, @rmekfProp, [], @rmekfMeas, Hargs);
end