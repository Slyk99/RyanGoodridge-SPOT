...
function [sc] = ShapeSpacecraft(param)
    ...
    elseif id == 9 % capstone chaser
        PROBE_LENGTH = 0.0508;
        PROBE_WIDTH = 0.08;
        PROBE_OFFSET = 0.03556;
        PIPE_THICKNESS = 0.015;
        ...
        sc = [cx,                               cy;
              ...
              cx+r,                             cy-r;
              cx+r,                             cy;
              cx+r,                             cy+PIPE_THICKNESS;
              cx+r+PROBE_OFFSET,                cy+PIPE_THICKNESS;
              cx+r+PROBE_OFFSET,                cy+PROBE_WIDTH/2;
              cx+r+PROBE_LENGTH+PROBE_OFFSET,   cy;
              cx+r+PROBE_OFFSET,                cy-PROBE_WIDTH/2;
              cx+r+PROBE_OFFSET,                cy-PIPE_THICKNESS;
              cx+r,                             cy-PIPE_THICKNESS;
              cx+r,                             cy];
    elseif id == 10 % capstone target
        DROGUE_LENGTH = 0.0508;
        DROGUE_WIDTH = 0.1;
        DROGUE_OVERHANG = 0.03;

        dW = (DROGUE_LENGTH-DROGUE_OVERHANG)*(DROGUE_WIDTH/DROGUE_LENGTH);

        sc = [cx,                       cy;
              cx+r,                     cy;
              cx+r,                     cy+r;
              cx-dW/2,                  cy+r;
              cx-DROGUE_WIDTH/2,        cy+r+DROGUE_OVERHANG+DROGUE_LENGTH;
              cx+DROGUE_WIDTH/2,        cy+r+DROGUE_OVERHANG+DROGUE_LENGTH;
              cx+dW/2,                  cy+r;
              cx-r,                     cy+r;
              cx-r,                     cy-SOLAR_PANEL_WIDTH/2;
