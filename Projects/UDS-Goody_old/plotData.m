...
for i = 1:3
    ...
    hold on;
      ...
      plot(t, wrapTo2Pi(data.xs(:,i)),     'm','LineWidth',1.2, 'DisplayName','smoothed');
    hold off;
    ylabel(poseLabels{i}, ...
...
for k = 1:3
    ...
    hold on;
      ...
      plot(t, data.xs(:,3+k),  'm','LineWidth',1.2, 'DisplayName','smoothed');
    hold off;
    ylabel(velLabels{k}, ...
           'Interpreter','latex','FontName','Times','FontSize',12)
    if k==1
...
for i = 1:3
    ...
    hold on;
      ...
      plot(t, es(:,i),   'm', 'DisplayName','smoothed e','MarkerSize',3);
    hold off;
    ylabel(poseLabels{i}, ...
           'Interpreter','latex','FontName','Times','FontSize',12)
    if i==1
...
plot(ax1, data.xs(:,1),     data.xs(:,2),     'm','LineWidth',1.5);
...
plot(ax2, t, wrapTo2Pi(data.xs(:,3)),   'm','LineWidth',1.5);
