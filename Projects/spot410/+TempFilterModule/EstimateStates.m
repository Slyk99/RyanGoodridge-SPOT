function [xStack, PStack, NAVout] = EstimateStates(xStack, PStack, u, dt, zGNS, zINS_full, navOpts)
    ...
    %% Add Bias
    zGNS_r = zGNS - r_PS;
    zINS_full_r = zINS_full - [r_Stereo; r_Lidar; r_LRF; r_IMU]; % Could be changed ti r_INS and the alpha could be stored as a vector
