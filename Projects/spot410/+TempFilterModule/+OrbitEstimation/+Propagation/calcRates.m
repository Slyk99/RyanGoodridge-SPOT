...
%
% Inputs:
%   x_rel   : 9x1 relative state [x; y; theta; theta_s; vx; vy; omega; omega_s; bias]
...
theta_s   = x_rel(4);      % inertial angle
v_rel     = x_rel(5:6);    % relative velocity [vx; vy]
omega_rel = x_rel(7);      % relative angular rate
